  ...
  <div class="form-app">
    <div class="result" v-if="subId">
      ...
      <div class="row">
        <div class="col-6">
          <h3>Herbs</h3>
          <zoom-center-transition v-if="fetching_results">
            <img src="/img/preloader.gif" />
          </zoom-center-transition>
          <SearchResults
            v-if="!fetching_results"
    ...
    <form class="form form-horizontal" @submit.prevent="newSubmission()">
      <div class="form-group row">
        <label for="plname" class="col-md-2 col-form-label"
          >Patient's Last Name <span class="required-asterik">*</span></label
        >
        <div class="col-md-10">
          <input
            type="text"
      ...
      <div class="form-group row">
        <label for="pfname" class="col-md-2 col-form-label"
          >Patient's First Name <span class="required-asterik">*</span></label
        >
        <div class="col-md-10">
          <input
            type="text"
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group row">
            <label for="pmname" class="col-md-4 col-form-label"
              >Middle Name</label
            >
            <div class="col-md-8">
              <input
        ...
        <div class="col-md-6">
          <div class="form-group row">
            <label for="pdob" class="col-md-4 col-form-label"
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group row">
            <label for="pcell" class="col-md-4 col-form-label"
              >Telephone (Cell) <span class="required-asterik">*</span></label
            >
            <div class="col-md-8">
              <input
                type="text"
        ...
        <div class="col-md-6">
          <div class="form-group row">
            <label for="pother" class="col-md-4 col-form-label"
              >Telephone (Other)</label
            >
            <div class="col-md-8">
              <input
                type="text"
      ...
      <div class="form-group row">
        <label for="pemail" class="col-md-2 col-form-label"
          >Email <span class="required-asterik">*</span></label
        >
        <div class="col-md-10">
          <input
            type="text"
      ...
      <div class="form-group row">
        <label for="paddress" class="col-md-2 col-form-label"
          >Address <span class="required-asterik">*</span></label
        >
        <div class="col-md-10">
          <input
            type="text"
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group row">
            <label for="pcity" class="col-md-6 col-form-label"
              >City <span class="required-asterik">*</span></label
            >
            <div class="col-md-6">
              <input
                type="text"
        ...
        <div class="col-md-4">
          <div class="form-group row">
            <label for="pstate" class="col-md-6 col-form-label"
              >State <span class="required-asterik">*</span></label
            >
            <div class="col-md-6">
              <input
                type="text"
        ...
        <div class="col-md-4">
          <div class="form-group row">
            <label for="pzip" class="col-md-6 col-form-label"
              >Zip <span class="required-asterik">*</span></label
            >
            <div class="col-md-6">
              <input
                type="text"
      ...
      <div class="form-group">
        <label for="preminder"
          >How would you like the appointment reminders be sent?</label
        >
        <div class="options">
          ...
          <div class="form-check form-check-inline">
            <input
              ...
              value="none"
            />
            <label class="form-check-label" for="remnone"
              >No Reminder Needed</label
            >
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="form-check">
          <input
            ...
            value="hot"
          />
          <label class="form-check-label" for="q3-hot"
            >Feel Like You Run Hot</label
          >
        </div>
        <div class="form-check">
          <input
            ...
            value="cold"
          />
          <label class="form-check-label" for="q3-cold"
            >Feel Like You Run Cold</label
          >
        </div>
        <div class="form-check">
          <input
            ...
            value="hot-cold"
          />
          <label class="form-check-label" for="q3-hot-cold"
            >Feel Like You Run Hot &amp; Cold</label
          >
        </div>
        <div class="form-check">
          <input
            ...
            value="normal"
          />
          <label class="form-check-label" for="q3-normal"
        ...
        <div class="two-col">
          <div class="form-check">
            <input
              ...
              value="t1-diab"
            />
            <label class="form-check-label" for="q4-t1-diab"
          ...
          <div class="form-check">
            <input
              ...
              value="t2-diab"
            />
            <label class="form-check-label" for="q4-t2-diab"
      ...
      <div class="two-col">
          ...
          <div class="two-col">
            ...
            <div class="form-check">
              <input
                ...
                v-model="q1"
              />
              <label class="form-check-label" for="q1-brainsurgery"
                >Brain Surgery</label
              >
            </div>
            <div class="form-check">
              <input
                ...
                value="pacemaker"
              />
              <label class="form-check-label" for="q1-pacemaker"
                >A Pacemaker</label
              >
            </div>
            <div class="form-check">
              <input
                ...
                v-model="q1"
              />
              <label class="form-check-label" for="q1-metalplates"
                >Metal Plates</label
              >
            </div>
            <div class="form-check">
              <input
                ...
                v-model="q1"
              />
              <label class="form-check-label" for="q1-breastbuttaug"
                >Breast or Butt Augmentation</label
              >
            </div>
          </div>
        </div>
        ...
        <div class="form-group" v-for="group in sign_groups" :key="group.key">
          ...
          <div class="two-col">
            <div
              class="form-check"
              v-for="sign in sign_groups_values[group.key]"
              :key="sign.id"
            >
              <input
                class="form-check-input"
      ...
      <template v-if="isadmin">
        ...
        <div class="form-group">
          ...
          <textarea
            ...
            v-model="doctorNotesTextarea"
            class="form-control"
          ></textarea>
        </div>
      </template>
      <div class="form-group btn-submit">
        <button :disabled="submitting" class="btn btn-primary btn-lg btn-block">
          Submit
        </button>
      </div>
    </form>
  ...
  data() {
    ...
    if (typeof submissionForm !== "undefined") {
      overrides = {
        ...
        sign_ids: submissionForm.result
          ? JSON.parse(submissionForm.result)
          : [],
        result: { herbs: [], herb_formulas: [] },
        editing: true,
        subId: submissionForm.id,
        fetching_results: true
      };
      axios
        .get(`/getsignresults/${JSON.stringify(overrides.sign_ids)}`)
        .then((response) => {
          this.result = response.data;
          this.fetching_results = false;
    ...
    let data = {
      ...
      chemicalComposition: this.items.filter(
        (item) => item.type === "chemical_composition"
      ),
      antibioticStrains: this.items.filter(
        (item) => item.type === "antibiotic_strains"
      ),
      submitting: false,
      editing: false,
      subId: false,
